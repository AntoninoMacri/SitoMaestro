...
import imagePath from "../../assets/SifuLoris.jpg"; // Import dell'immagine
...
function __VLS_template() {
    ...
    ['bg-gray-100', 'min-h-screen', 'flex', 'flex-col', 'max-w-7xl', 'mx-auto', 'p-8', 'flex', 'flex-col', 'md:flex-row', 'justify-between', 'items-start', 'gap-y-6', 'md:gap-x-8', 'w-full', 'md:w-2/3', 'flex', 'flex-col', 'gap-8', 'text-left', 'text-lg', 'text-gray-700', 'space-y-6', 'text-red-600', 'font-bold', 'text-5xl', 'text-black', 'font-bold', 'text-2xl', 'w-full', 'md:w-1/3', 'w-full', 'rounded-lg', 'shadow-lg', 'cursor-pointer', 'transition-transform', 'hover:scale-105', 'md:max-h-90', 'object-cover', 'text-center', 'text-gray-600', 'mt-4', 'fixed', 'inset-0', 'bg-black', 'bg-opacity-75', 'flex', 'items-center', 'justify-center', 'max-w-full', 'max-h-full', 'rounded-lg', 'shadow-lg',];
    var __VLS_slots;
    var $slots;
